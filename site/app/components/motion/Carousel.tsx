...
function CarouselNavigation({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none flex justify-between px-2",
        className
      )}
    >
      <button
      ...
      >
        <MoveLeft className="stroke-zinc-600 dark:stroke-zinc-50" size={40} />
      </button>
      <button
        type="button"
        className={cn(
      ...
      >
        <MoveRight className="stroke-zinc-600 dark:stroke-zinc-50" size={40} />
      </button>
    </div>
  );
}
